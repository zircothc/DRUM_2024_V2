...
void synthESP32_begin(){
  ...
  i2s_pin_config_t i2s_pin_config2 = {
    .bck_io_num = I2S_BCK_PIN2,
    .ws_io_num =  I2S_WS_PIN2,
    .data_out_num = I2S_DATA_OUT_PIN2
  };
  ...
  i2s_set_pin(I2S_NUM_1, &i2s_pin_config2);
...
//  vmeter=lsample_out;
  ...
  if (i2s_out_device==0 || i2s_out_device==2) i2s_write(I2S_NUM_0, out_buf, sizeof(out_buf), &bytes_written, portMAX_DELAY);
	if (i2s_out_device==1 || i2s_out_device==2) i2s_write(I2S_NUM_1, out_buf, sizeof(out_buf), &bytes_written, portMAX_DELAY);
